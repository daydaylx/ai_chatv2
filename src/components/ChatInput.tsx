...
export function ChatInput({ value, onChange, onSend, busy }:{
  ...
  return (
    <div className="sticky bottom-0 inset-x-0 p-2 bg-black/45 backdrop-blur-md border-t border-white/10">
      <div className="flex gap-2">
        <textarea
          ref={taRef}
          rows={1}
          className="flex-1 resize-none bg-white/8 border border-white/12 rounded-xl px-3 py-2 outline-none focus:border-[hsl(var(--accent-400))] placeholder:opacity-60"
