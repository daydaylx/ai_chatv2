...
export default function ChatSheet() {
  const { chats, currentChatId, setCurrentChat, createChat, deleteChat, renameChat, duplicateChat } =
    useChatStore((s) => ({
      chats: s.chats,
  ...
  // Ein/Ausblenden kannst du später über Parent-State steuern; hier bleibt die Liste sichtbar.
